...
const MOCK_STUDENTS = [
  {
    ...
    quiz: [88, 92, 85, 90, 94],
    passportStatus: '보관 중',
    flightInfo: 'KE631 | 06-01 입국', flightTime: '09:40', pickupRequired: true,
  ...
  },
  {
    ...
    quiz: [88, 91, 93, 90],
    passportStatus: '보관 중',
    flightInfo: 'VN632 | 06-01 입국', flightTime: '13:15', pickupRequired: true,
  ...
  },
  {
    ...
    quiz: [],
    passportStatus: '미제출',
    flightInfo: 'VN634 | 06-15 입국 예정', flightTime: '11:05', pickupRequired: true,
    dietType: '일반식',
  ...
  },
  {
    ...
    quiz: [95, 98, 97],
    passportStatus: '보관 중',
    flightInfo: 'KE603 | 06-01 입국', flightTime: '19:20', pickupRequired: true,
    dietType: '일반식',
    healthNotes: '특이사항 없음.',
  ...
  },
  {
    ...
    quiz: [],
    passportStatus: '보관 중',
    flightInfo: 'KE721 | 06-10 입국 예정', flightTime: '15:50', pickupRequired: true,
    dietType: '일반식',
  ...
  // ── 추가 목업 데이터 ──
  {
    ...
    quiz: [84, 87, 89, 91],
    passportStatus: '보관 중',
    flightInfo: 'JL774 | 06-09 입국', flightTime: '08:30', pickupRequired: true,
    dietType: '일반식',
    healthNotes: '특이사항 없음.',
  ...
  },
  {
    ...
    quiz: [76, 80, 83, 85],
    passportStatus: '보관 중',
    flightInfo: 'MU553 | 06-01 입국', flightTime: '17:00', pickupRequired: true,
    dietType: '일반식',
  ...
  },
  {
    ...
    quiz: [90, 93],
    passportStatus: '보관 중',
    flightInfo: 'KE635 | 06-08 입국', flightTime: '10:10', pickupRequired: true,
    dietType: '일반식',
    healthNotes: '특이사항 없음.',
  ...
  },
  {
    ...
    quiz: [],
    passportStatus: '미제출',
    flightInfo: 'VN636 | 06-15 입국 예정', flightTime: '14:35', pickupRequired: true,
    dietType: '일반식',
    healthNotes: '신규 등록 — 건강정보 미제출.',
    grades: { speaking: [], listening: [], reading: [], writing: [] },
    fees: []
  },
  {
    ...
    quiz: [86, 89, 91],
    passportStatus: '보관 중',
    flightInfo: 'KE637 | 06-03 입국', flightTime: '12:25', pickupRequired: true,
    dietType: '채식',
    healthNotes: '특이사항 없음.',
  ...
  },
  {
    ...
    quiz: [92, 95, 97, 96],
    passportStatus: '보관 중',
    flightInfo: 'KE639 | 06-01 입국', flightTime: '11:40', pickupRequired: true,
    dietType: '일반식',
    healthNotes: '특이사항 없음.',
  ...
  },
  {
    ...
    attendance: 0, status: 'waiting', remittanceStatus: 'paid', agency: '한국 영어마을', warning: 0,
    passportNum: 'M10000029', passportStatus: '미보관', flightInfo: 'KE703 | 08-01 입국 예정', flightTime: '09:15', pickupRequired: true, dietType: '일반식', healthNotes: '',
    fees: [
